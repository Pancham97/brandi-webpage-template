...
goToSlide(nthSlide) {
  ...
  for (let dot of this.dots) {
    dot.className = dot.className.replace(this.Enum.ACTIVE, '');
  }
  this.slides[this.currentSlide].style.display = this.Enum.BLOCK;
  this.dots[this.currentSlide].className = this.Enum.ACTIVE;
}
